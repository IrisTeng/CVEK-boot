...
MultiScore2 <- 
  function(formula, label.names, 
    ...
    result <- Ensemble(Y ~ X1 + X2, label.names, Kernlist, 
...
KernelBoot <- 
  function(formula, label.names, Kernlist, mode, strategy, 
    ...
    result <- Ensemble(formula, label.names, Kernlist, data0, 
    ...
    return(list(pvalue = bs.pvalue, bs.test = bs.test, 
