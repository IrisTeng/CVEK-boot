...
testing <- function(formula_int, label_names, Y, X1, X2, kern_list,
  ...
  pvalue_asym <- do.call("test_asym", list(n = n, Y = Y, X12 = X12, 
                                           beta0 = beta0, alpha0 = alpha0,
                                           K_gpr = K_gpr, sigma2_hat = sigma2_hat, 
                                           tau_hat = tau_hat, B = B))
  
  pvalue_boot <- do.call("test_boot", list(n = n, Y = Y, X12 = X12, 
                                           beta0 = beta0, alpha0 = alpha0,
                                           K_gpr = K_gpr, sigma2_hat = sigma2_hat, 
                                           tau_hat = tau_hat, B = B))
  ...
  list(pvalue = pvalue_asym, pvalue2 = pvalue_boot, 
       u_weight = u_weight, 
